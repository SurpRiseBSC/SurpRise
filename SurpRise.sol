...
contract SurpRise is Context, IBEP20, Ownable {
    ...
    address payable public marketingAddress = payable(0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db); // Marketing Address
    ...
    uint256 public _maxTxAmount = 1000000 * 10**6 * 10**9;      // Max Buy/Sell: 1.0%
    uint256 public _maxWalletAmount = 2000000 * 10**6 * 10**9; // Max Wallet:    2.0%
